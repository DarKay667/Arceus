...
public class GuiUtils
{
    ...
    {
        d *= 2.0D; f *= 2.0D; e *= 2.0D; g *= 2.0D;
        GL11.glScalef(0.5F, 0.5F, 0.5F);
        drawVLine((float)d, (float)e, (float)g - 1.0F, borderC);
        drawVLine((float)f - 1.0F, (float)e, (float)g, borderC);
        drawHLine((float)d, (float)f - 1.0F, (float)e, borderC);
        drawHLine((float)d, (float)f - 2.0F, (float)g - 1.0F, borderC);
        drawRect((float)d + 1.0F, (float)e + 1.0F, (float)f - 1.0F, (float)g - 1.0F, insideC);
        GL11.glScalef(2.0F, 2.0F, 2.0F);
    }
    ...
    public void drawRectDouble(double paramXStart, double paramYStart, double paramXEnd, double paramYEnd, int paramColor)
    {
